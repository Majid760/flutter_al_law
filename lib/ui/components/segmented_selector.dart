...
//import 'package:flutter_al_law/ui/components/sliding_segmented_control.dart';
/*
SegmentedSelector(
...
class SegmentedSelector extends StatelessWidget {
  SegmentedSelector(
      {@required this.menuOptions, @required this.selectedOption, @required this.onValueChanged});
